...
5. Quitting the game. Press 'q' while the game map is open, then press 'Esc' to quit the game.
6. Going to the next floor. Kill the 'G'oblin keymaster, pick up the 'k'ey, walk over a 'L'adder tile and press 'v' to descend.
